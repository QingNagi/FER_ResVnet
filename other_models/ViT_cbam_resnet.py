...
class ECABasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, k_size=3):
        ...
        self.stride = stride
        self.cbam = CBAM(planes, kernel_size=3)
...
def eca_resnet18(k_size=[3, 3, 3, 3], num_classes=8, pretrained=False):
    model = ResNet(ECABasicBlock, [2, 2, 2, 2], num_classes=num_classes, k_size=k_size)
    # model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model


def eca_resnet34(k_size=[3, 3, 3, 3], num_classes=7, pretrained=False):
...
def eca_resnet50(k_size=[3, 3, 3, 3], num_classes=7, pretrained=False):
