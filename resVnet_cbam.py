...
from eca_module import eca_layer, eca_layer3d
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=7, k_size=[3, 3, 3, 3]):
        ...
        self.lin1 = nn.Linear(512 * 6, 4096)
        self.lin2 = nn.Linear(4096, 4096)
        self.drop = nn.Dropout(p=0.2)
        self.eca3d = eca_layer3d(6, 1)
        self.cbam = CBAM(512, kernel_size=3)
        self.cbam_1 = CBAM(64)
...
def resVnet18_CBAM(k_size=[3, 3, 3, 3], num_classes=7, pretrained=False):
